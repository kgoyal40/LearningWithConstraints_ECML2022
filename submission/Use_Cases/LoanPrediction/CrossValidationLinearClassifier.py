...
def cross_validate_parameter_selection(X, y, params=None, n_folds=5):
                ...
                for epoch in params['epoch']:
                    for batch_size in params['batch_size']:
                        ...
                        for train_index, val_index in split_data:
                            ...
                            y_train, y_val = [y[i] for i in train_index], \
                                             [y[i] for i in val_index]
    ...
    val_evaluation_params.columns = ['margin', 'knowledge', 'learning rate', 'epochs', 'batch size',
                                     'average validation loss']
    # val_evaluation_params.to_csv('cross_validation_output.csv')

    return val_evaluation_params, selected_parameters, CV_log
